...
<GameScene interactive={true} zoom={3}>
  <ImportStructure src="../ac_assets/sturcture/lightning_convert_magnets.snbt" />
...
<GameScene interactive={true} zoom={3}>
  <Block x="0" y="0" z="0" id="anvilcraft:stamping_platform" />
  <Block x="0" y="2" z="0" id="minecraft:anvil" />
  <ItemEntity pos="0 1 0" id="anvilcraft:geode" />
  <IsometricCamera yaw="195" pitch="30" />
</GameScene>
