...
<ItemLink id="anvilcraft:block_devourer" />可以迅速精准的破坏前方一大片的方块，因此可以用来制作*盾构机*

# 简易盾构机（3x3)

在这里给出一种简单的*盾构机*的示例：

- 通过红石激活<ItemLink id="anvilcraft:block_devourer" />，不断破坏掉前方3x3范围的方块
- 可以在开掘出的隧道中修建交通，或者挖矿
...
<GameScene zoom="3" background="#888888" interactive={true}>
    ...
    <ImportStructure src="../ac_assets/structure/machine/tunnel_boring_3x.snbt" />
...
- 更新 <ItemLink id="minecraft:sticky_piston" /> 启动机器
- 要停下就把机器拆了
...
通过控制铁砧下落撞击<ItemLink id="anvilcraft:block_devourer" />，可以挖掘更大的隧道

从 2 格高落下的铁砧会使被砸到的<ItemLink id="anvilcraft:block_devourer" />挖掘前方 7x7 的方块
...
<Row>
<GameScene zoom="3" background="#888888" interactive={true}>
    <ImportStructure src="../ac_assets/structure/machine/tunnel_boring_7x.snbt" />
    <IsometricCamera yaw="185" pitch="10" />
