...
- 阅读[矿物获取](../recipe/basic_minerals.md)可知，*粉碎*是十分重要的加工步骤
- <ItemLink id="anvilcraft:block_placer" />后面箱子中的方块会被放出
- 方块立刻被<ItemLink id="minecraft:anvil" />砸个粉碎
...
<GameScene zoom="3" background="#888888" interactive={true}>
    <ImportStructure src="../ac_assets/structure/machine/crush.snbt" />
