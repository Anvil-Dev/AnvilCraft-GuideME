...
1. 使用<ItemLink id="anvilcraft:induction_light" />加快大树的生长
2. 使用<ItemLink id="anvilcraft:giant_anvil" />撼地的冲击破破坏大树
3. 使用<ItemLink id="anvilcraft:item_collector" />范围收集掉落物
...
<GameScene zoom="3" background="#888888" interactive={true}>
    ...
    <ImportStructure src="../ac_assets/structure/machine/tree.snbt" />
